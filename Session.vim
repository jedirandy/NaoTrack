...
badd +7 src/Detection/FrameCapturer.cpp
...
badd +0 src/Detection/PlayGround/camera.cpp
silent! argdel *
...
exe 'vert 3resize ' . ((&columns * 101 + 113) / 227)
argglobal
...
silent! normal! zE
let s:l = 53 - ((18 * winheight(0) + 13) / 26)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 30 - ((14 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30

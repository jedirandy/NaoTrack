...
badd +19 src/Detection/DetectionTest.cpp
badd +1 src/Detection/Tuto-AxisMirage/tuto.cc
badd +11 ~/Projects/Vimrc/snippets/make.snippets
badd +1 src/Detection/MirageExamples/makefile
badd +1 ~/workspace/makefile
badd +16 ~/workspace/GoF/FactoryPattern/makefile
badd +12 src/Detection/FrameCapturer.h
badd +30 src/Detection/FrameCapturer.cpp
badd +2 ~/Projects/Vimrc/\[Vundle]\ clean
badd +23 ~/Projects/Vimrc/\[Vundle]\ Installer
badd +6 DetectionTest.cpp
badd +10 ~/workspace/GlogTest/main.cpp
badd +1 src/Detection/PlayGround/camera.cpp
silent! argdel *
...
exe 'vert 3resize ' . ((&columns * 125 + 109) / 219)
exe '4resize ' . ((&lines * 26 + 28) / 56)
exe 'vert 4resize ' . ((&columns * 93 + 109) / 219)
argglobal
...
wincmd w
argglobal
edit src/Detection/PlayGround/camera.cpp
xnoremap <buffer> <silent> 	 :python updateSnips()
nnoremap <buffer> <silent> 	 :python updateSnips()
snoremap <buffer> <silent> 	 :python updateSnips()
onoremap <buffer> <silent> 	 :python updateSnips()
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 88 - ((7 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
88
...
wincmd w
argglobal
edit src/Detection/FrameCapturer.h
xnoremap <buffer> <silent> 	 :python updateSnips()
nnoremap <buffer> <silent> 	 :python updateSnips()
snoremap <buffer> <silent> 	 :python updateSnips()
onoremap <buffer> <silent> 	 :python updateSnips()
...
wincmd w
argglobal
edit src/Detection/FrameCapturer.cpp
nnoremap <buffer> <silent> 	 :python updateSnips()
xnoremap <buffer> <silent> 	 :python updateSnips()
snoremap <buffer> <silent> 	 :python updateSnips()
onoremap <buffer> <silent> 	 :python updateSnips()
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((11 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
